export const SeeMoreIcon = ({ width = '1.6rem', height = '0.3rem', className }) => (
    <svg className={className} width={width} height={height} viewBox="0 0 16 3" xmlns="http://www.w3.org/2000/svg">
        <path
